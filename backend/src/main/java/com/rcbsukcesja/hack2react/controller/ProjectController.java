...
public class ProjectController {
    ...
    @PostMapping
    public ResponseEntity<ProjectView> createProject(@RequestBody @Valid ProjectDto projectDto) {
        return new ResponseEntity<>(projectService.createOrUpdateProject(null, projectDto), HttpStatus.CREATED);
    }

    @PutMapping("/{projectId}")
    public ResponseEntity<ProjectView> updateProject(@PathVariable UUID projectId, @RequestBody @Valid ProjectDto projectDto) {
        return new ResponseEntity<>(projectService.createOrUpdateProject(projectId, projectDto), HttpStatus.OK);
    }
