...
export function CompanyDetailsScreen({ route }: AuthenticatedStackScreenProps<'CompanyDetails'>) {
      ...
      <BottomSheet>
        <View style={styles.content}>
          ...
          <ScrollView style={styles.infoWrapper} contentContainerStyle={{ justifyContent: 'space-between', gap: 4 }}>
            ...
            <Text type="primaryBold">Nasze obszary biznesowe:</Text>
            ...
            <Text type="primaryBold">Wspieramy</Text>
            {donatedProjects?.length ? (
              ...
              <Text>Brak danych o wspartych projektach</Text>
            )}
          </ScrollView>
        </View>
      </BottomSheet>
